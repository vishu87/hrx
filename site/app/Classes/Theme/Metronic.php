...
class Metronic
{
    ...
    public static function initThemes()
    {
        ...
        $themes[] = 'assets/dist/css/themes/layout/header/base/'.config('layout.header.self.theme').'.css';
        $themes[] = 'assets/dist/css/themes/layout/header/menu/'.config('layout.header.menu.desktop.submenu.theme').'.css';
        $themes[] = 'assets/dist/css/themes/layout/aside/'.config('layout.aside.self.theme').'.css';

        if (config('layout.aside.self.display')) {
            $themes[] = 'assets/dist/css/themes/layout/brand/'.config('layout.brand.self.theme').'.css';
        } else {
            $themes[] = 'assets/dist/css/themes/layout/brand/'.config('layout.header.self.theme').'.css';
        }
