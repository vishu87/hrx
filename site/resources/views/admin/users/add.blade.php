	...
	<div class="card card-custom">
        ...
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <a href="{{url('/admin/users')}}" class="btn btn-dark" >Go Back</a>
            </div>
        </div>
        ...
        <div class="card-body">
        	...
        	@if($user)
        		{{Form::open(["url"=>"admin/users/store/".$user->id, "method"=>"post","class"=>"check-form"])}}
        	@else
        		{{Form::open(["url"=>"admin/users/store", "method"=>"post","class"=>"check-form"])}}
        	@endif
        	<div class="row">
        		...
        		<div class="col-md-4 form-group">
                  ...
                  <!--   @if(!$user)
                    ...
                    @else
                        {{Form::email('email',($user)?$user->email:'',["class"=>"form-control" , "required"=>true,"readonly"=>"true"])}}
                    @endif -->
                    {{Form::email('email',($user)?$user->email:'',["class"=>"form-control" , "required"=>true])}}
